		...
		switch (action_status){
			...
			case aStates.startUp:
				...
				if(movestun==0){
					...
					//create the hitbox
					hitbox=instance_create_layer(x-30,y,"Boxes",obj_hitbox);
					...
					var push_data=array(90-20*facing,25,15,-1);
					...
					with(hitbox){
						...
						image_xscale=4.8;image_yscale=2;
					}
					...
					if(true){
						...
						force.angle=90;force.owner=id;with(force){alarm_set(0,10);}
