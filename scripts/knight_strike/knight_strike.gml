		...
		switch (action_status){
			...
			case aStates.startUp:
				...
				if(movestun==0){
					...
					//create the hitbox
					hitbox=instance_create_layer(x+50*facing,y,"Boxes",obj_hitbox);
					...
					var push_data=array(90-100*facing,40,15,-1);
